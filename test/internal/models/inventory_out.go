...
type InventoryOut struct {
	...
	IsDeleted  bool          `json:"is_deleted" db:"is_deleted" `                 //删除状态(0: 未删除 1: 已删除)
	...
	Quantity   sqlca.Decimal `json:"quantity" db:"quantity" `                     //数量
	Weight     sqlca.Decimal `json:"weight" db:"weight" `                         //净重
...
func (do *InventoryOut) GetIsDeleted() bool          { return do.IsDeleted }
func (do *InventoryOut) SetIsDeleted(v bool)         { do.IsDeleted = v }
