...
type InventoryData struct {
	...
	Quantity     sqlca.Decimal `json:"quantity" db:"quantity" `                         //产品库存
	Price        sqlca.Decimal `json:"price" db:"price" `                               //产品均价
	ProductExtra string        `json:"product_extra" db:"product_extra" sqlca:"isnull"` //产品附带数据(JSON文本)
	Location     sqlca.Point   `json:"location" db:"location" sqlca:"isnull"`           //地理位置
}
