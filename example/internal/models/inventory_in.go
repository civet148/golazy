...
type InventoryIn struct {
	...
	CreatedAt  time.Time     `json:"created_at" db:"created_at" gorm:"column:created_at;type:timestamp;autoCreateTime;index:idx_inventory_in_created_at;default:CURRENT_TIMESTAMP;"` //
	UpdatedAt  time.Time     `json:"updated_at" db:"updated_at" gorm:"column:updated_at;type:timestamp;autoUpdateTime;index:idx_inventory_in_updated_at;default:CURRENT_TIMESTAMP;"` //
